...
public class AntSimGUI extends JFrame
{
	...
	private class ControlPanel extends JPanel
	{
		...
		//button for setting up to test the queen ant with the ability to spawn new ants
		private JButton queenAltButton;
		...
		private void initComponents()
		{
			...
			//alternative queen test button
			queenAltButton = new JButton("Alternative Queen Test");
			queenAltButton.addActionListener(buttonHandler);
			queenAltButton.setToolTipText("Set up simulation for testing the queen ant with the ability to spawn new ants");
		...
		private class ButtonHandler implements ActionListener
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else if(b.getText().equals("Alternative Queen Test")) 
				{
					fireSimulationEvent(SimulationEvent.ALTERNATIVE_QUEEN_EVENT);
				}
