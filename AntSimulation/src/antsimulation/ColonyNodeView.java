...
public class ColonyNodeView extends JPanel
{
	...
	private void initComponents()
	{
		...
		queenIcon = new JLabel(new ImageIcon("src/images/queen.gif"));
		queenIcon.setVisible(false);
		
		// indicates presence of scout ant
		scoutIcon = new JLabel(new ImageIcon("src/images/scout.gif"));
		scoutIcon.setVisible(false);
		
		// indicates presence of forager ant
		foragerIcon = new JLabel(new ImageIcon("src/images/forager.gif"));
		foragerIcon.setVisible(false);
		
		// indicates presence of soldier ant
		soldierIcon = new JLabel(new ImageIcon("src/images/soldier.gif"));
		soldierIcon.setVisible(false);
		
		// indicates presence of Bala ant
		balaIcon = new JLabel(new ImageIcon("src/images/bala.gif"));
